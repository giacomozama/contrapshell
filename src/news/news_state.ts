...
export type NewsState = {
    newsItems: Accessor<NewsItem[]>;
    refreshNews: () => void;
    fetchImage: (url: string) => Promise<Gio.File | undefined>;
};

let newsStateInstance: NewsState | null;
...
function createNewsState(): NewsState {
    ...
    return newsStateInstance;
}

export function newsState(): NewsState {
    return newsStateInstance ?? createRoot(createNewsState);
}
