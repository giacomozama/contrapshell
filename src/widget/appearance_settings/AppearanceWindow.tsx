...
import { parseRGBA, rgbaToHex } from "../../utils/colors";
import {
    accent1,
    accent2,
    applyAppearance,
    ...
    updatePalette,
    wallpaper,
} from "../../state/appearance_settings/appearance_settings_state";
