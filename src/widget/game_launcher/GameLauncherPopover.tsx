...
import { GameLauncherEntry } from "../../state/game_launcher/types";
...
import { steamEntries } from "../../state/game_launcher/steam";
import { bottlesEntries } from "../../state/game_launcher/bottles";
import { createState, onCleanup } from "gnim";
import { DockItem } from "../../state/dock/types";
import { titleCase } from "../../utils/strings";
import { launchers } from "../../state/game_launcher/game_launcher_state";
...
export function GameLauncherDockItem({
    ...
    return (
        ...
        >
            <Squircle>
                <image pixelSize={42} widthRequest={48} heightRequest={48} iconName={iconName} tooltipText={tooltip} />
            </Squircle>
