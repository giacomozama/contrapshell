...
import { MediaStatus } from "../../state/media/types";
import { activeMediaPlayer, availableMediaPlayers, mediaState, watchActivePlayer } from "../../state/media/media_state";
...
function MediaControlsPopover() {
    return (
        <glassypopover widthRequest={600} color1={accentColor1} color2={accentColor2}>
            <box layoutManager={new Gtk.BinLayout()} hexpand={true} vexpand={true}>
                <box cssClasses={["cover-art-background"]}>
                    <box
                        hexpand={true}
                        vexpand={true}
                ...
                >
                    ...
                    >
                        ...
                        <Gtk.DropDown
                            ...
                            selected={createComputed(
                                [availableMediaPlayers, activeMediaPlayer],
                                (available, active) => {
                    ...
                    <box orientation={Gtk.Orientation.VERTICAL} class="media-controls-inner">
                        ...
                        <slider
                            ...
                            css={accentColor1.as((c) => `--slider-color: ${rgbaToHex(c)};`)}
